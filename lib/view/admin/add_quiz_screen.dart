...
class _AddQuizScreenState extends State<AddQuizScreen> {
 ...
 List<QuestionFormItem> _questionFormItems =[];
  ...
  void _removeQuestion(int index) {
    if (_questionFormItems.length > 1) { // Don't remove the last question
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title:  Text(widget.categoryName!= null ? "Add ${widget.categoryName} quiz": 'Add Quiz ',
        style: TextStyle(
        ...
        child: ListView(
          ...
          children: [
            Column(
              ...
              children: [
                Text('Quiz Details', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 10),
                          ...question.optionsControllers.asMap().entries.map((optionEntry) {
