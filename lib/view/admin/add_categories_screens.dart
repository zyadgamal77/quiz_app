...
class _AddCategoriesScreensState extends State<AddCategoriesScreens> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        child: Padding(
         ...
         SizedBox(height: 8),
         Text("Create a new category for organizing your quizzes",
          style: TextStyle(
            fontSize: 14,
           fontWeight: FontWeight.bold,
            color: AppTheme.textPrimaryColor,
   ...
   color: AppTheme.textPrimaryColor,
    ...
    validator: (value)=> value!.isEmpty ? "Please enter description name" : null,
    textInputAction: TextInputAction.next,
    ),
    SizedBox(height: 32),
    SizedBox(height: 50,width: double.infinity,
    child: ElevatedButton(onPressed: _isLoading ? null : _saveCategory,
    child: _isLoading?
    SizedBox(
      height: 20,
      width: 20,
